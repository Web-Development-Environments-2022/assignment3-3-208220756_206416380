...
export default {
    ...
    methods: {
      ...
      checkFormValidity() {
        ...
        for( let i = 0 ; i < this.$refs.ingrediants.length; i++ ){
            /*console.log()
            console.log(this.$refs.ingrediants[i].$options.propsData.state)
            this.$refs.ingrediants[i].state = this.$refs.ingrediants[i].checkValidity()
            console.log(this.$refs.ingrediants[i].$options.propsData.state)
            console.log(this.$refs.ingrediants[i])*/
        }

        for( let i = 0 ; i < this.$refs.instructions.length; i++ ){
            /*this.$refs.instructions[i].$options.propsData.state = this.$refs.instructions[i].checkValidity()*/
        }
      ...
      async submit(){
        ...
        const response = await this.axios.post(
          "http://localhost/users/familyrecipes",
          fd,
